...
train_agent_for_left_hand = True
...
# Train the agent
sarsa.fit(env, nb_steps=100000, visualize=False, verbose=2, callbacks=callbacks)

# Test the agent
scores = sarsa.test(env, nb_episodes=10, visualize=True)
print(np.mean(scores.history['episode_reward']))

# Save the weights
sarsa.save_weights('sarsa_weights_for_left_hand_gestures.h5f', overwrite=True)
