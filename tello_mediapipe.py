...
def get_frame():
    ...
    with mp_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5) as face_mesh, (image\_float - np.min(image\_float)) / (np.max(image\_float) - np.min(image\_float))
